...
export const TABLE_ROW_INNER_HEIGHT = 20
export const TABLE_ROW_VERT_PAD = 2
export const TABLE_ROW_BOT_BORDER = 1
export const TABLE_ROW_HEIGHT =
  TABLE_ROW_INNER_HEIGHT + TABLE_ROW_VERT_PAD * 2 + TABLE_ROW_BOT_BORDER

export const STATUS_COLUMN_WIDTH = 30
export const ERRORS_COLUMN_WIDTH = 300
