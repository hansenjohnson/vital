...
const IssueSummaryControls = ({
  ...
  const issuesWithNonZeroCounts = orderedIssuesWithCounts.filter(([, count]) => count !== 0)
  if (issuesWithNonZeroCounts.length === 0) return null
  ...
  return (
    <Box>
      ...
      {issuesWithNonZeroCounts.map(([issue, count]) => (
